...
const endpoint = new TextToTextTranslationEndpoint(null);
export const textToTextFunction = express.Router();
textToTextFunction.get('/', endpoint.request.bind(endpoint));